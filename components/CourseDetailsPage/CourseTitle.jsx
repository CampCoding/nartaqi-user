  ...
  return (
    <div className="container mx-auto px-[64px] my-[48px] flex items-center justify-center">
      <div className="inline-flex flex-col justify-start items-center gap-4">
        <div className="text-center justify-center text-tertiary text-[35px] font-bold leading-loose">
          {title || "إتقان التدريس الفعال - معلمين"}
        </div>
        <div className="px-4 py-2 bg-secondary rounded-xl inline-flex justify-center items-center">
          {breadcrumbs?.map((crumb, idx) => (
            <React.Fragment key={idx}>
              <Link href={crumb.link ? crumb.link : "#"}
                className={`justify-center text-lg leading-normal ${
