    ...
    <div className="flex flex-col items-start gap-2 sm:gap-3 lg:gap-4 px-4 sm:px-6 lg:px-8 py-3 sm:py-4 lg:py-6 bg-white rounded-lg border border-solid border-variable-collection-stroke w-full max-w-[479px]">
      <div className="w-full">
        <div className="font-bold text-text text-lg sm:text-xl lg:text-2xl leading-tight sm:leading-relaxed text-center sm:text-right whitespace-nowrap">
          {sectionTitle ? "أسئلة القسم" : "الأسئلة"}
        </div>
        {sectionTitle && (
          <div
      ...
      <div className="flex flex-wrap w-full items-start justify-start gap-2 sm:gap-3 lg:gap-4">
        {Array.from({ length: totalQuestions }).map((_, index) => (
          <button
            ...
            className={`flex flex-col w-9 h-9 sm:w-12 sm:h-12 lg:w-14 lg:h-14 items-center justify-center gap-2 rounded-md sm:rounded-md lg:rounded-lg transition ${getBoxStyle(index)}`}
          >
            <div className="font-medium text-base sm:text-lg text-right leading-tight sm:leading-relaxed whitespace-nowrap">
              {index + 1}
            </div>
          </button>
        ))}
      ...
      <div className="flex flex-col w-full items-center gap-2 sm:gap-3 lg:gap-4">
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 flex-1">
            <div className="bg-primary w-4 sm:w-5 lg:w-6 h-4 sm:h-5 lg:h-6 rounded-md flex-shrink-0" />
            <span className="font-medium text-text text-xs sm:text-sm lg:text-base leading-tight sm:leading-relaxed">
              الحالي
            </span>
          </div>
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 flex-1">
            <div className="bg-yellow-400 w-4 sm:w-5 lg:w-6 h-4 sm:h-5 lg:h-6 rounded-md flex-shrink-0" />
            <span className="font-medium text-text text-xs sm:text-sm lg:text-base leading-tight sm:leading-relaxed">
              المعلقة
            </span>
          </div>
        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 flex-1">
            <div className="bg-secondary w-4 sm:w-5 lg:w-6 h-4 sm:h-5 lg:h-6 rounded-md flex-shrink-0" />
            <span className="font-medium text-text text-xs sm:text-sm lg:text-base leading-tight sm:leading-relaxed">
              المجاب عنه
            </span>
          </div>
          <div className="flex items-center gap-2 sm:gap-3 lg:gap-4 flex-1">
            <div className="bg-[#d9d9d9] w-4 sm:w-5 lg:w-6 h-4 sm:h-5 lg:h-6 rounded-md flex-shrink-0" />
