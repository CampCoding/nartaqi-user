    ...
    <div className="flex flex-col gap-[48px]">
      ...
      <div className=" text-right justify-center  leading-loose ">
        <span className="text-text text-xl font-medium ">
          ...
          مهاراتهم على استخدام أحدث استراتيجيات وأساليب التدريس الفعّال. حصل على
          درجة الماجستير في التربية من جامعة عالمية مرموقة، إلى جانب العديد من
          الشهادات الدولية المتخصصة في التعليم الرقمي وإدارة الصفوف الدراسية
          الحديثة.
          <br />
          عمل جون سميث مع عدد من المدارس والجامعات والمؤسسات التعليمية حول
          العالم، وساهم في تصميم برامج تدريبية مبتكرة تستهدف رفع كفاءة المعلمين
          وتحسين جودة التعليم. قام بتقديم أكثر من 250 دورة تدريبية وورشة عمل في
          مجالات مثل: إدارة الصف، استراتيجيات التعليم التفاعلي، تطوير المناهج،
          والتحفيز الأكاديمي للطلاب.
          <br />
