          ...
          <div className="w-full inline-flex flex-col justify-start items-start gap-4">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              <div className="self-stretch h-9 px-3 inline-flex justify-start items-center gap-8">
                {data.badge && (
                  <div
                    className={`px-9 py-3 ${isRound ? "bg-red-400/25" : "bg-primary-bg"
...
const ChevronIcon = ({ onClick, direction, disabled }) => (
  <svg
    ...
    className={`${direction === "up" ? "rotate-180" : ""
      } hover:scale-105 h-6 cursor-pointer transition-transform active:scale-95 ${disabled ? "opacity-30 cursor-not-allowed" : ""
      }`}
  >
    <path
