  ...
  return (
    <div className="flex flex-col items-start gap-2 sm:gap-4 lg:gap-6 w-full">
      <div className="flex items-center justify-start gap-2 sm:gap-3 lg:gap-4 w-full">
        {/* ✅ اللون هنا يتحدد بـ text-primary */}
        <InfoIcon className="text-primary w-5 sm:w-6 lg:w-7 h-5 sm:h-6 lg:h-7 flex-shrink-0" />
...
function InstructionRow({ children }) {
  return (
    <div className="flex items-start gap-4 sm:gap-6 lg:gap-8 w-full">
      {/* ✅ اللون هنا يتحدد بـ text-primary */}
      <CheckIcon className="text-primary w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 flex-shrink-0 mt-0.5" />
