...
const FirstsCard = ({ data, icon }) => {
  return (
    <div
      ...
      className="relative w-full md:w-[305px] h-[430px] flex flex-col items-center bg-white rounded-[40px] shadow-2xl"
    >
      <div className="flex flex-col w-[289px] items-center gap-8 relative top-[49px] ">
        <div className="relative self-stretch w-full h-40">
          <div
            className={`absolute w-40 h-40 top-0 left-[65px] rounded-[80px] overflow-hidden`}
            style={{
              backgroundColor: icon?.bg,
            }}
          >
            <div
              className={`w-16 h-16 top-[26px] left-12 rounded-[64px] absolute `}
              style={{
                backgroundColor: icon?.icon,
              }}
            />
            <div
              className={`w-60 h-60 top-[107px] -left-10 rounded-[240px] absolute `}
              style={{
                backgroundColor: icon?.icon,
              }}
            />
        ...
        <div className="flex flex-col w-[234px] items-center gap-4 relative flex-[0_0_auto]">
          ...
          <div
            ...
            className={` text-2xl font-bold leading-8 relative self-stretch text-center`}
          >
            {data?.percentage}
          </div>
        </div>
