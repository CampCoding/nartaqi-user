...
const VerbalSection = ({ sectionTitle = "||", sectionDescription = "||" }) => {
  return (
    <div className="inline-flex flex-col justify-start items-start gap-8">
      ...
      <div className="flex-1 text-right justify-center text-text-alt text-xl font-normal leading-10" dangerouslySetInnerHTML={{ __html: sectionDescription?.replace(/&nbsp;/gi, " ") || (
