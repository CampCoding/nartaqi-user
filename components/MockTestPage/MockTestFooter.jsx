  ...
  return (
    <header
      className="
        ...
        px-2 py-2 sm:px-6 sm:py-4 lg:px-16 lg:py-6
        landscape:py-1 md:landscape:py-4
        flex-nowrap gap-1 sm:gap-4 overflow-x-auto no-scrollbar z-20
      "
      role="banner"
      dir="rtl"
    >
      <div className="flex items-center gap-2 sm:gap-6 shrink-0">
        <button
          className="flex items-center justify-center gap-1 sm:gap-2 px-1 sm:px-2 py-0.5 sm:py-1 hover:opacity-80 transition-opacity focus:outline-none shrink-0"
          role="button"
          aria-label="معلومات السؤال"
          onClick={() => setIsQuestionInfoOpen(true)}
        >
          <div className="w-3 h-3 sm:w-5 sm:h-5 landscape:w-2.5 landscape:h-2.5 md:landscape:w-5 md:landscape:h-5 flex items-center justify-center [&>svg]:w-full [&>svg]:h-full">
            <BookIcon />
          </div>
          <span className="font-medium text-white text-[10px] sm:text-sm md:text-base landscape:text-[9px] md:landscape:text-base tracking-[0] whitespace-nowrap">
            معلومات السؤال
          </span>
        </button>
        ...
        {isStart && (
          <button
            className="flex items-center justify-center gap-1 sm:gap-2 px-1 sm:px-2 py-0.5 sm:py-1 hover:opacity-80 transition-opacity shrink-0"
            role="region"
            aria-label="صفحة المراجعة"
            onClick={() => setIsInReview(true)}
          >
            <div className="w-3 h-3 sm:w-5 sm:h-5 landscape:w-2.5 landscape:h-2.5 md:landscape:w-5 md:landscape:h-5 flex items-center justify-center [&>svg]:w-full [&>svg]:h-full">
              <InfoIcon />
            </div>
            <h1 className="font-medium text-white text-[10px] sm:text-sm md:text-base landscape:text-[9px] md:landscape:text-base tracking-[0] whitespace-nowrap">
              صفحة المراجعة
            </h1>
          </button>
        )}
      ...
      {isStart ? (
        <nav
          className="flex items-center justify-end gap-2 sm:gap-4 lg:gap-[34px] shrink-0"
          role="navigation"
        >
          <button
            className={`flex items-center gap-1 sm:gap-[5px] transition-opacity ${!canGoPrevious ? "opacity-50 cursor-not-allowed" : "hover:opacity-80"}`}
            type="button"
            onClick={onPrevious}
            disabled={!canGoPrevious}
          >
            <div className="w-2.5 h-2.5 sm:w-5 sm:h-5 landscape:w-2 landscape:h-2 md:landscape:w-5 md:landscape:h-5 flex items-center justify-center [&>svg]:w-full [&>svg]:h-full">
          ...
          <button
            className="flex items-center gap-1 sm:gap-[5px] hover:opacity-80"
            type="button"
            onClick={onNext}
          >
            <div className="flex cursor-pointer justify-center px-2 py-1 sm:px-4 sm:py-1.5 landscape:py-0.5 md:landscape:py-1.5 bg-primary-dark rounded-md sm:rounded-[10px] items-center">
              <span className="font-medium text-white text-[10px] sm:text-sm md:text-base landscape:text-[9px] md:landscape:text-base tracking-[0] whitespace-nowrap">
        ...
        >
          ...
          >
            <div className="flex justify-center px-3 py-1 sm:px-6 sm:py-1.5 landscape:py-0.5 md:landscape:py-1.5 bg-primary-dark rounded-md sm:rounded-[10px] items-center">
              <span className="font-medium text-white text-[10px] sm:text-sm md:text-base landscape:text-[9px] md:landscape:text-base tracking-[0] whitespace-nowrap">
                ابدأ
              </span>
            </div>
...
export const ReviewFooter = ({
  ...
  return (
    <header
      className="bg-primary relative flex w-full items-center justify-between px-3 py-2 sm:px-6 sm:py-6 lg:px-16 lg:py-8 landscape:py-1 md:landscape:py-6 flex-col md:flex-row gap-2 sm:gap-4"
      role="banner"
      dir="rtl"
    >
      <nav
        className="flex items-center justify-center gap-1.5 sm:gap-4 flex-wrap md:flex-nowrap w-full md:w-auto"
        role="navigation"
      >
        {filterButtons
          .slice()
          ...
          .map((button) => (
            <button
              ...
              className={`flex justify-center items-center gap-1 sm:gap-2 px-2 py-1 sm:px-4 sm:py-3 landscape:py-0.5 md:landscape:py-3 rounded-md sm:rounded-[15px] border border-solid border-white/20 hover:bg-white hover:bg-opacity-10 transition-colors ${activeFilter === button.id ? "bg-white/20" : ""}`}
            >
              <div className="w-3 h-3 sm:w-5 sm:h-5 landscape:w-2.5 landscape:h-2.5 md:landscape:w-5 md:landscape:h-5 flex items-center justify-center [&>svg]:w-full [&>svg]:h-full">
                {button.icon}
              </div>
              <span className="font-medium text-white text-[9px] sm:text-sm landscape:text-[8px] md:landscape:text-sm whitespace-nowrap">
                {button.text}
              </span>
            </button>
          ))}
      ...
      <button
        onClick={() => setIsInReview(false)}
        className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-6 sm:py-3 landscape:py-1 md:landscape:py-3 bg-white rounded-md sm:rounded-[20px] hover:bg-gray-50 transition-colors w-full sm:w-auto shrink-0"
      >
        <div className="w-3 h-3 sm:w-5 sm:h-5 landscape:w-2.5 landscape:h-2.5 md:landscape:w-5 md:landscape:h-5 flex items-center justify-center [&>svg]:w-full [&>svg]:h-full">
          <ExitIcon />
        </div>
        <span className="font-medium text-[#be1919] text-[10px] sm:text-base landscape:text-[9px] md:landscape:text-base whitespace-nowrap">
          إنهاء المراجعة
        </span>
      </button>
    </header>
