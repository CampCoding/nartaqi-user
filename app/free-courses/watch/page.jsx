...
function WatchContent() {
  ...
  const title = searchParams.get("title") || "فيديو مجاني";
  const category = searchParams.get("category") || "الشروحات المجانية";
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa]">
      ...
      <PagesBanner
        ...
        breadcrumb={[
          { title: "الرئيسية", link: "/" },
          { title: "الشروحات المجانية", link: -1 },
          { title: title, link: "#" },
        ]}
      ...
      <Container className="py-8 md:py-12">
        ...
        >
          ...
          <span className="font-medium">العودة للشروحات المجانية</span>
        </Link>
        ...
        {hasVideo ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-16 text-center">
            ...
            >
              <span>تصفح الشروحات المجانية</span>
            </Link>
          </div>
        )}
      </Container>
